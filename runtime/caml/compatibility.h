...
/* **** minor_gc.c */
#define young_start CAML_DEPRECATED("young_start", "Caml_state->_young_start") Caml_state->_young_start
#define young_end CAML_DEPRECATED("young_end", "Caml_state->_young_end") Caml_state->_young_end
#define young_ptr CAML_DEPRECATED("young_ptr", "Caml_state->_young_ptr") Caml_state->_young_ptr
#define young_limit CAML_DEPRECATED("young_limit", "Caml_state->_young_limit") Caml_state->_young_limit
...
/* **** roots.c */
#define local_roots CAML_DEPRECATED("local_roots", "Caml_state->_local_roots") Caml_state->_local_roots
...
#define try_leave_blocking_section_hook CAML_DEPRECATED("try_leave_blocking_section_hook", "caml_try_leave_blocking_section_hook") caml_try_leave_blocking_section_hook
...
#define sys_exit CAML_DEPRECATED("sys_exit", "caml_sys_exit") caml_sys_exit
