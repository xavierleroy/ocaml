...
module Test(H: Digest.S) = struct
  ...
  let chunks msg hh step =
    let st = H.create() in
    let len = String.length msg in
    let rec add pos =
      if pos + step <= len then begin
        H.add_substring st msg pos step;
        add (pos + step)
      end else begin
        H.add_substring st msg pos (len - pos)
      end in
    add 0;
    assert (H.(equal (get_digest st) (of_hex hh)))
  ...
  let run_tests (h1, h2, h3, h4, h5) =
    whole in1 h1; whole in2 h2; whole in3 h3; whole in4 h4; whole in5 h5;
    chunks in1 h1 1; chunks in2 h2 1; chunks in3 h3 1;
    chunks in4 h4 10; chunks in5 h5 100;
    file 100 99;
    file 100_000 10_000
end
...
let _ = TestBLAKE512.run_tests
  ("786a02f742015903c6c6fd852552d272912f4740e15847618a86e217f71f5419\
   ...
   "fe89a110a412012e7cc5c0e05b03b48a6b9d0ba108187826c5ac82ce7aa45e7e\
...
let _ = TestBLAKE256.run_tests
  ("0e5751c026e543b2e8ab2eb06099daa1d1e5df47778f7787faab45cdf12fe3a8",
   ...
   "b717c86cf745507ec5373f12f21350eb8550039b4263f7ba6e8df9030b5673c6")
...
let _ = TestBLAKE128.run_tests
  ("cae66941d9efbd404e4d88758ea67670",
   ...
   "5c4b4b762807b3290e7eee0aa9b18655")
